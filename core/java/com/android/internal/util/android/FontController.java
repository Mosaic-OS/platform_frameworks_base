...
public class FontController {
    ...
    private Typeface getOverrideTypefaceInternal(String fontToOverride) {
        ...
        try {
            ...
            // Never let a font override failure break text rendering; fall back to stock.
            Log.w(TAG, "getOverrideTypeface failed for " + fontToOverride, t);
            return null;
        }
    }
    ...
    private void handleOnConfiguration(Resources res) {
        try {
            ...
            // Never let a font override failure take down the app process.
            Log.w(TAG, "handleOnConfiguration failed", t);
        }
    }
