...
public final class RotationPolicy {
    ...
    // Lazily computed from an immutable sysprop; volatile so the check-then-set in
    // getNaturalRotation() is safely visible across threads (the value is identical anyway).
    private static volatile int sNaturalRotation = -1;
