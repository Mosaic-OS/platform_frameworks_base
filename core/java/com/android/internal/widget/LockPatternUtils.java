...
public class LockPatternUtils {
    ...
    public void reportPasswordLockout(Duration timeout, int userId) {
        reportPasswordLockout(timeout, userId, Primary);
    }

    public void reportPasswordLockout(Duration timeout, int userId, LockDomain lockDomain) {
    ...
    public VerifyCredentialResponse checkCredential(@NonNull LockscreenCredential credential, LockDomain lockDomain,
            int userId, @Nullable CheckCredentialProgressCallback progressCallback) {
        throwIfCalledOnMainThread();
        try {
            final VerifyCredentialResponse response =
                    getLockSettings()
                            .checkCredential(credential, lockDomain, userId, wrapCallback(progressCallback));
