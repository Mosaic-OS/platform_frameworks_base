...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    void init(Injector injector) {
        ...
        mContext.registerReceiver(torchReceiver, filter, Context.RECEIVER_NOT_EXPORTED);
    ...
    void updateSettings(Handler handler) {
        ...
        synchronized (mLock) {
            ...
            mTorchLongPressPowerEnabled = Settings.Secure.getIntForUser(
                    resolver, Settings.Secure.TORCH_LONG_PRESS_POWER_GESTURE, 0,
                    UserHandle.USER_CURRENT) == 1;
            mTorchTimeout = Settings.Secure.getIntForUser(
                    resolver, Settings.Secure.TORCH_LONG_PRESS_POWER_TIMEOUT, 0,
                    UserHandle.USER_CURRENT);
    ...
    private void dispatchDirectAudioEvent(KeyEvent event) {
        ...
        // or forwarded to the TV. It's up to Amplifier manufacturerâ€™s implementation.
