...
public class QuickSettingsControllerImpl implements QuickSettingsController, Dumpable {
    ...
    boolean isOpenQsEvent(MotionEvent event) {
        ...
        // Only compute the one-finger pulldown region when the feature is enabled AND the QS view
        // exists. mQs can be null while the QS fragment view is detached, and this method runs for
        // every touch, so it must not dereference mQs unconditionally.
