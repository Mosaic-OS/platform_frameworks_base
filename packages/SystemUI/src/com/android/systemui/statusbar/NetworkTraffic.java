...
public class NetworkTraffic extends TextView {
    ...
    public NetworkTraffic(Context context, AttributeSet attrs, int defStyle) {
            ...
            private String formatOutput(long kbps) {
                ...
                switch (mUnits) {
                    ...
                    case UNITS_AUTOBYTES:
                        ...
                        // Intentional fall-through: AUTOBYTES auto-promotes to MB at >= 8000 kbps.
        ...
        // Settings + network callbacks are applied in onAttachedToWindow() and torn down in
        // onDetachedFromWindow(), so callbacks are never left registered on an unattached view.
    }
    ...
    private void updateTrafficDrawable() {
        ...
        mDrawable = drawableResId != 0 ? mContext.getDrawable(drawableResId) : null;
